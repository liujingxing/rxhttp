...
class DownloadFragment : BaseFragment<DownloadFragmentBinding>(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.rxjava_download10 -> coroutineDownload10(v)
            R.id.rxjava_downloadProgress10 -> coroutineDownloadProgress10(v)
            R.id.rxjava_appendDownloadProgress10 -> coroutineAppendDownloadProgress10(v)
            ...
            R.id.rxjava_download -> coroutineDownload(v)
            R.id.rxjava_downloadProgress -> coroutineDownloadProgress(v)
            R.id.rxjava_appendDownloadProgress -> coroutineAppendDownloadProgress(v)
