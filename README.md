...
dependencies {
    ...
    kapt 'com.ljx.rxhttp:rxhttp-compiler:2.3.2' //生成RxHttp类，非kotlin项目，请使用annotationProcessor代替kapt
    ...
    implementation 'com.ljx.rxhttp:converter-jackson:2.3.2'
    implementation 'com.ljx.rxhttp:converter-fastjson:2.3.2'
    implementation 'com.ljx.rxhttp:converter-protobuf:2.3.2'
    implementation 'com.ljx.rxhttp:converter-simplexml:2.3.2'
}
```
