...
```java
dependencies {
   implementation 'com.rxjava.rxhttp:rxhttp:1.2.2'
   annotationProcessor 'com.rxjava.rxhttp:rxhttp-compiler:1.2.2' //注解处理器，生成RxHttp类
   implementation 'com.rxjava.rxlife:rxlife:1.1.0'  //页面销毁，关闭请求，非必须

   // if you use kotlin
   kapt 'com.rxjava.rxhttp:rxhttp-compiler:1.2.2'
}
```
